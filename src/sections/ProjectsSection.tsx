...
const projects: ProjectData[] = [
  {
    number: '01',
    category: 'Data Analytics Capstone Project',
    name: 'Bluestock Mutual Fund Analytics & Modeling',
    date: 'Jun 2026 - Jul 2026',
    techStack: ['Python', 'Pandas', 'SQLite', 'SciPy', 'Plotly', 'Streamlit', 'Power BI (DAX)'],
    bullets: [
      'Developed an end-to-end automated ETL pipeline ingesting 17+ raw datasets and live REST APIs into a SQLite star-schema database to analyze 5-year performance across 40 mutual fund schemes.',
      'Engineered advanced quantitative financial models to calculate Sharpe Ratio, CAPM Alpha/Beta, and 95% Historical VaR, culminating in a composite Fund Scorecard that dynamically ranked top-performing assets.',
      'Designed an interactive Streamlit web dashboard and formulated Markowitz Efficient Frontier optimization algorithms, uncovering a 97% SIP churn-risk rate and guiding optimal portfolio weight allocation.',
    ],
  ...
  },
  {
    ...
    name: 'E-Commerce Sales Analysis & Interactive Dashboard',
    date: 'May 2026 - Jun 2026',
    techStack: ['Python', 'Pandas', 'NumPy', 'Matplotlib', 'Seaborn', 'SQL', 'Power BI (DAX)', 'Excel'],
    bullets: [
      'Analyzed 100,000+ e-commerce transactions using SQL (JOINs, CTEs, Window Functions) and Python to extract business KPIs including Revenue, AOV, and CLV.',
      'Applied RFM (Recency, Frequency, Monetary) segmentation, identifying top 20% customers generating 67% of $2.1M total revenue, driving targeted retention strategies.',
      'Engineered an interactive Power BI dashboard with DAX measures tracking Total Revenue ($2.1M), Monthly Growth (12%), and Customer Retention Rate (34%).',
    ],
    githubUrl: 'https://github.com/priyanshub3542',
  },
  {
    ...
    name: 'Video Surveillance Anomaly Detection System',
    date: 'Nov 2025 - May 2026',
    techStack: ['Python', 'PyTorch', 'OpenCV', 'YOLO', 'CNN-LSTM', 'Computer Vision'],
    bullets: [
      'Developed a real-time video surveillance system using deep learning to detect crowd (CSRNet), fire/smoke (YOLO), and violence (CNN-LSTM).',
      'Designed a pipeline to process video frames and generate real-time anomaly alerts using PyTorch, TensorFlow, and OpenCV.',
      'Optimized performance using CUDA and built a real-time monitoring interface with Streamlit.',
    ],
    githubUrl: 'https://github.com/priyanshub3542',
  },
];
